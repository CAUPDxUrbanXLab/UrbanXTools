...
- [目录](#目录)
  * [**介绍**](#介绍)
    ...
    + [4. 合作单位](#44. 合作单位)
  * [**安装步骤**](#安装步骤)
    + [1. 下载文件](#1. 从github里下载文件，并解压，取出)
    + [2. 置入文件](#2. 打开Rhino，打开Grasshopper，进入Component File)
    + [3. 重启软件](#3. 检查文件夹内容完整性，重启Rhino)
    + [4. 顺利置入](#4. 顺利置入)
    + [5. 注意](#5. 注意)
  * [**演示**](#演示)
    + [1. 空间结构交互性评估](#1. 空间结构交互性评估)
    + [2. 公共服务设施覆盖分析](#2. 公共服务设施覆盖分析)
    + [3. 城市设计方案自动生成](#3. 城市设计方案自动生成)
    + [4. 城市设计方案资源荷载计算](#4. 城市设计方案资源荷载计算)
    + [5. 城市设计方案曝光度分析](#5. 城市设计方案曝光度分析)
  * [**工具内容**](#工具内容)
    + [1. 空间句法计算](#1. 空间句法计算)
    + [2. 设施计算](#2. 设施计算)
    + [3. 自动生成](#3. 自动生成)
    + [4. 资源指标计算](#4. 资源指标计算)
    + [5. 空间指标计算](#5. 空间指标计算)
    + [6. 水管网计算（Coming Soon）](#6. 水管网计算（Coming Soon）)
  * [**许可证**](#许可证)
